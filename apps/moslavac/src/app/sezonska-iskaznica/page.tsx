...
export default async function SeasonTicketPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-screen-xl space-y-24 px-6 py-16 sm:space-y-32 sm:py-24 lg:px-8">
      ...
      <SectionBlock title="Tvoje mjesto na tribini">
      ...
      <SectionBlock id="podaci-za-uplatu" title="Podaci za uplatu">
...
function SectionBlock({
  ...
  return (
    <section id={id} className="space-y-12 sm:space-y-16">
