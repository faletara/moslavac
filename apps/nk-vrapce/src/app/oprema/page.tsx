    ...
    <header className="flex flex-col items-center gap-8 text-center">
      ...
      {webshopHref && (
        <a
          ...
          className="group inline-flex items-center gap-2 border border-brand-yellow bg-brand-yellow px-6 py-3 text-[0.65rem] font-bold uppercase tracking-[0.3em] text-brand-navy transition-colors hover:bg-transparent hover:text-brand-navy"
        >
          Posjeti webshop
