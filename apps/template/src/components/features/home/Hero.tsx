...
export default function Hero({ tenant }: HeroProps) {
	...
	return (
		...
		>
			{/* Tinted gradient backdrop (club color over deep navy). Golden-path ships
			    without a hardcoded photo; a club can add an <Image> backdrop here. */}
			<motion.div
				aria-hidden
			...
			>
				<div className="absolute inset-0 bg-club/30 mix-blend-color" />
